...
def health():
    return {
        ...
        "features": ["multi_goal", "training_days", "triathlon_distances", "running_distances", "trail_running", "sequential_workouts", "vacation_mode", "subscriptions", "mandatory_feedback", "live_edit", "athlete_metrics", "training_library", "telegram_json_import", "bulk_text_import", "cycle_assignment", "1rm", "ftp", "thresholds", "two_week_testing", "figure_single_branch", "client_targeted_notifications"],
    }
